...
A token is used to authenticate and identify a user, and allow/deny access based off who the user is and their permissions
- [x] What steps can you take in your web apps to keep your data secure?
Private/protected routes that require you to be authenticated via login and token before giving up data
- [x] Describe how web servers work.
Web servers run server code and serve data when websites request it
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
All of them- post, get, put, delete
